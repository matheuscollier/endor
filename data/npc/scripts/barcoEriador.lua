...
keywordHandler:addKeyword({'ir'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Edoras}, {Belfallas}, {Argond}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Edoras}, {Belfallas}, {Argond}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
keywordHandler:addKeyword({'viajar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Edoras}, {Belfallas}, {Argond}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
