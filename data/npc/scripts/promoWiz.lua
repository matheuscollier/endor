			...
			if getPlayerVocation(cid) == tabela[x] then
				if getPlayerLevel(cid) >= 35 then
					if (getPlayerVocation(cid) == 1) then
						npcHandler:say('Voce quer ser promovido para Wizard por 10.000gp?', cid)
						talkState[talkUser] = 1
						
					elseif (getPlayerVocation(cid) == 35) and getPlayerLevel(cid) >= 101 then
						npcHandler:say('Voce quer ser promovido para High Wizard por 30.000gp?', cid)
						talkState[talkUser] = 1
						
					elseif (getPlayerVocation(cid) == 36) and getPlayerLevel(cid) >= 200 then
