...
travelKeyword = keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Dol\'Guldur}, {Lorien}, {Rivendell}, {Grey Mountains}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
travelKeyword = keywordHandler:addKeyword({'ir'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Dol\'Guldur}, {Lorien}, {Rivendell}, {Grey Mountains}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
travelKeyword = keywordHandler:addKeyword({'viajar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Dol\'Guldur}, {Lorien}, {Rivendell}, {Grey Mountains}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
