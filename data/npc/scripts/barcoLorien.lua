...
keywordHandler:addKeyword({'ir'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para o {Pantano}, {Dol\'Guldur}, {Rivendell}, {Edoras}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para o {Pantano}, {Dol\'Guldur}, {Rivendell}, {Edoras}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
keywordHandler:addKeyword({'viajar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para o {Pantano}, {Dol\'Guldur}, {Rivendell}, {Edoras}, {Dunedain} ou {Mordor} por uma pequena taxa.'})
