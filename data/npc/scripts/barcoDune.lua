...
travelKeyword = keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Edoras}, {Pantano}, {Dol\'Guldur}, {Lorien}, {Rivendell}, {Grey Mountains}, {Belfallas}, {Eriador}, {Mordor} ou {Argond} por uma pequena taxa.'})
travelKeyword = keywordHandler:addKeyword({'ir'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Edoras}, {Pantano}, {Dol\'Guldur}, {Lorien}, {Rivendell}, {Grey Mountains}, {Belfallas}, {Eriador}, {Mordor} ou {Argond} por uma pequena taxa.'})
travelKeyword = keywordHandler:addKeyword({'viajar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para {Edoras}, {Pantano}, {Dol\'Guldur}, {Lorien}, {Rivendell}, {Grey Mountains}, {Belfallas}, {Eriador}, {Mordor} ou {Argond} por uma pequena taxa.'})
