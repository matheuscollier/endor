...
function lookAtPlayer(cid)

	local bunda = creatureGetPosition(cid)
	myx, myy, myz = selfGetPosition()
	
	if ((myy-bunda.y==0) and (myx-bunda.x<=0 and myx-bunda.x>=-4)) then
		return selfTurn(1)
	elseif ((myy-bunda.y==0) and (myx-bunda.x>=0 and myx-bunda.x<=4)) then
		return selfTurn(3)
	elseif ((myx-bunda.x==0) and (myy-bunda.y<=0 and myy-bunda.y>=-4)) then
		return selfTurn(2)
	elseif ((myx-bunda.x==0) and (myy-bunda.y>=0 and myy-bunda.y<=4)) then
		return selfTurn(0)
	elseif ((myy-bunda.y==-2) and (myx-bunda.x>=-1 and myx-bunda.x<=1)) then
		return selfTurn(2)
	elseif ((myy-bunda.y==2) and (myx-bunda.x>=-1 and myx-bunda.x<=1)) then
		return selfTurn(0)
	elseif ((myx-bunda.x==2) and (myy-bunda.y>=-1 and myy-bunda.y<=1)) then
		return selfTurn(3)
	elseif ((myx-bunda.x==-2) and (myy-bunda.y>=-1 and myy-bunda.y<=1)) then
		return selfTurn(1)
	elseif ((myy-bunda.y==-3) and (myx-bunda.x>=-2 and myx-bunda.x<=2)) then
		return selfTurn(2)
	elseif ((myy-bunda.y==3) and (myx-bunda.x>=-2 and myx-bunda.x<=2)) then
		return selfTurn(0)
	elseif ((myx-bunda.x==3) and (myy-bunda.y>=-2 and myy-bunda.y<=2)) then
		return selfTurn(3)
	elseif ((myx-bunda.x==-3) and (myy-bunda.y>=-2 and myy-bunda.y<=2)) then
		return selfTurn(1)
	elseif ((myy-bunda.y==-4) and (myx-bunda.x>=-3 and myx-bunda.x<=3)) then
		return selfTurn(2)
	elseif ((myy-bunda.y==4) and (myx-bunda.x>=-3 and myx-bunda.x<=3)) then
		return selfTurn(0)
	elseif ((myx-bunda.x==4) and (myy-bunda.y>=-3 and myy-bunda.y<=3)) then
		return selfTurn(3)
	elseif ((myx-bunda.x==-4) and (myy-bunda.y>=-3 and myy-bunda.y<=3)) then
		return selfTurn(1)
	end
...
getNpcDistanceToCreatureCreature = getNpcDistanceToCreature
