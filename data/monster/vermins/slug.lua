...
monster.loot = {
	{id = 2148, chance = 20750, maxCount = 45},
	{id = 3976, chance = 50000, maxCount = 5}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 45, attack = 40},
	{name ="combat", interval = 1000, chance = 15, minDamage = -5, maxDamage = -40, range = 4, type = COMBAT_EARTHDAMAGE, ShootEffect = CONST_ANI_POISON, effect = CONST_ME_HITBYPOISON, target = true}
}
