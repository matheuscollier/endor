...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 9, minDamage = -200, maxDamage = -320, type = COMBAT_EARTHDAMAGE, effect = CONST_ME_BIGPLANTS, target = true}
}
