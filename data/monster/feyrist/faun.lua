...
monster.loot = {
	...
	{id = 1294, chance = 492},
	{id = 2146, chance = 1492},
	{id = 2681, chance = 30100},
	{id = 2515, chance = 450},
	{id = 2195, chance = 450}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -70, maxDamage = -370},
	{name ="combat", interval = 2000, chance = 15, minDamage = -60, maxDamage = -150, type = COMBAT_EARTHDAMAGE, range = 7, ShootEffect = CONST_ANI_POISON, target = true},
