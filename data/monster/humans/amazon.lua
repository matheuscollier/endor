...
monster.description = "uma amazon"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -15, maxDamage = -35},
	{name ="combat", interval = 3500, chance = 99, minDamage = -10, maxDamage = -20, type = COMBAT_PHYSICALDAMAGE, range = 6, ShootEffect = CONST_ANI_THROWINGKNIFE, target = false}
}
