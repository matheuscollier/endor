...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -25, maxDamage = -65},
	{name ="combat", interval = 3700, chance = 99, minDamage = -10, maxDamage = -20, type = COMBAT_PHYSICALDAMAGE, range = 7, ShootEffect = CONST_ANI_ARROW, target = false}
}
