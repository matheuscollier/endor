local modalWindowTeleporterHunt = CreatureEvent("modalWindowTeleporterHunt")
function modalWindowTeleporterHunt.onModalWindow(cid, modalWindowId, buttonId, choiceId)
	cid:unregisterEvent("modalWindowTeleporterHunt")
...
modalWindowTeleporterHunt:register()
